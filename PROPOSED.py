...
# Position update is Done using the value at line 30
# Enhanced Dove Swarm Optimization Algorithm (DSOA)
def PROPOSED(W, objective_function, lower_bound, upper_bound, num_epochs):
